...
(1,'husu','husu@metropolia.fi','nopass','04685410','espoo','2024-11-05 19:26:43');
...
CREATE TABLE `menu_items` (
  ...
  `category` enum('Food','Drink','Dessert','Main-course','Main course') NOT NULL,
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'Samsa','a very traditional food from east',19.99,'Food');
...
(1,1,'2024-11-05 19:33:34','Completed',9.99);
...
-- Dump completed on 2024-11-05 21:57:26
